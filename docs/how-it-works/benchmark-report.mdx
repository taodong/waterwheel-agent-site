...
The test dependency chain (node order and prerequisites) is defined separately in [<a href="/files/benchmark/preset-context.json" target="_blank" rel="noopener noreferrer">preset-context.json</a>].
...
### Verdict
`Claude Sonnet 4.6` is the stronger choice for speed and reliability. it completed the full suite faster, maintained lower output verbosity, and showed more consistent behavior across longer tests. Its cache warmed up more gradually. 
