...
:::note
All files mentioned in this section are bundled in [local-install.zip](/files/installation/local-install.zip). Download it and extract its contents before proceeding.
:::
