...
:::note
All files mentioned in this section are bundled in [waterwhell-installer.zip](/files/installation/waterwheel-installer-1.3.0.zip). Download it and extract its contents before proceeding.
:::
