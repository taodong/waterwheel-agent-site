...
[tags page](https://github.com/taodong/duotail-waterwheel-skills/tags).
...
| `waterwheel-load-test-skills` | Reloads the project's user-defined [test skills](../getting-started/create-test-skills.mdx) from the `testSkills` folder into the container (requires agent image `1.4.0`+) |
...
2. **Load** — `waterwheel-load-tests`, `waterwheel-load-instructions`, and
   `waterwheel-load-test-skills` push your markdown test tasks, configuration,
   permissions, localhost settings, and user-defined test skills into the container.
...
[Create Test Skills](../getting-started/create-test-skills.mdx) for how to write one
