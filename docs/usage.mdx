...
description: Full reference for every command available inside the Waterwheel agent container.
---
...
This page documents every command in the container, listed alphabetically. If you have not run a
test of your own yet, start with [Write Your First Test](./write-your-first-test) — it walks through
the commands you need in the order you need them.
